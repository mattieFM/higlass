...
import { all as icons } from '@higlass/core/src/scripts/icons'; // './icons';
import { createApi } from '@higlass/core';
...
class HiGlassComponent extends React.Component {
  ...
  getTrackInfo(trackType) {
    ...
    console.warn(
      ...
      trackType,
      '(check packages/core/scripts/config/ for a list of defined track types)',
    );
    return undefined;
  }
