...
export const tracks = {
  SVGTrack: AVAILABLE_FOR_PLUGINS.tracks.SVGTrack,
  TiledPixiTrack: AVAILABLE_FOR_PLUGINS.tracks.TiledPixiTrack,
  HorizontalGeneAnnotationsTrack: AVAILABLE_FOR_PLUGINS.tracks.HorizontalGeneAnnotationsTrack,
};

export const ChromosomeInfo = AVAILABLE_FOR_PLUGINS.chromosomes.ChromosomeInfo;
...
export { schema } from '@higlass/core';

// export functions that are useful for testing
export {
  getTrackObjectFromHGC,
} from '@higlass/core'; // configs
