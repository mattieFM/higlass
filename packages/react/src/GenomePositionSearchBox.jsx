...
const { ChromosomeInfo, SearchField } = AVAILABLE_FOR_PLUGINS.chromosomes;
import PopupMenu from './PopupMenu';

// Services
import { tileProxy } from '@higlass/core'; // './services';
import withPubSub from './hocs/with-pub-sub';

// Utils
import { scalesCenterAndK, dictKeys, toVoid } from '@higlass/core'; // './utils';

// HOCS
import withTheme from './hocs/with-theme';
import { SearchIcon } from '@higlass/core/src/scripts/icons';
// Configs
import { THEME_DARK, ZOOM_TRANSITION_DURATION } from '@higlass/core'; // './configs';
