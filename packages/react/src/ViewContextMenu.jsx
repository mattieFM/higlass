...
import { mix } from '@higlass/core/src/scripts/mixwith'; // './mixwith';

import { expandCombinedTracks } from '@higlass/core'; // './utils';
...
import { THEME_DARK } from '@higlass/core'; // './configs';
